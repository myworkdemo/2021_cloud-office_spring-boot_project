...
public class CommandLineAppStartupRunner implements CommandLineRunner {
	...
	Logger log = LoggerFactory.getLogger(CommandLineAppStartupRunner.class);

	@Override
	public void run(String... args) throws Exception {

		System.out.println("## CommandLineAppStartupRunner : run() calling...");
	...
	private void loadStateAndCities() {
		System.out.println("## CommandLineAppStartupRunner : loadStateAndCities() calling...");

		FileReader cities_reader = null;
		FileReader state_reader = null;
		StateAndCities stateAndCities = null;
		log.error("## CommandLineAppStartupRunner : loadStateAndCities() calling...");
		try {
			...
			log.error("## CommandLineAppStartupRunner : loadStateAndCities() ", e.getMessage());
			e.printStackTrace();
		}
	...
	private void loadAllUserRoleWithDefaultPermissions() {
		...
		log.error("## CommandLineAppStartupRunner : loadAllUserRoleWithDefaultPermissions()...");
		...
		for (Resource resource : resourceList) {
			...
			log.error("## CommandLineAppStartupRunner : loadAllUserRoleWithDefaultPermissions() ", e.getMessage());
		}
